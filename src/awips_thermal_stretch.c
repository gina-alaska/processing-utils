...
{
  printf
    ("This tool is a simple util for stretching thermal data for awips.  Works in a strange manner, just a FWI.\n");
  printf
...
void
parse_opts (int argc, char **argv, double *min, double *middle, double *max,
...
char
scale (double min, double middle, double max, double value)
{
  double result = 0.0;
