...
GDALDatasetH
make_me_a_sandwitch (GDALDatasetH * in_dataset, const char *filename)
{
...
ussage (const char *progname)
{
  ...
  fprintf (stderr,
	   "Problems? Questions? Complain to jay@alaska.edu so he can ignore them..\n\nBy now.\n\n");
  exit (-1);
}
